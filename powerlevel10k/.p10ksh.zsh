# Generated by Powerlevel10k configuration wizard on 2020-02-05 at 00:37 +07.
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    ...
    dir_writable            # writable directory status
    # =========================[ Line #2 ]=========================
    newline                 # \n
  ...
  typeset -g POWERLEVEL9K_DIR_WRITABLE_FORBIDDEN_FOREGROUND='009'
  typeset -g POWERLEVEL9K_DIR_NOT_WRITABLE_FORBIDDEN_FOREGROUND='009'
  ...
  typeset -g POWERLEVEL9K_MULTILINE_LAST_PROMPT_PREFIX='%F{014}\u2570 %F{031}\uF054%F{073}\uF054'
  ...
  #################################[ os_icon: os identifier ]##################################
  # OS icon
  # typeset -g POWERLEVEL9K_LINUX_UBUNTU_ICON=''    # Apple - \uf179 - 
  typeset -g POWERLEVEL9K_LINUX_UBUNTU_ICON=''      # Windows - \uf17a - 
  # OS identifier color.
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=219
  ...
  typeset -g POWERLEVEL9K_VCS_CLEAN_FOREGROUND='118'
  typeset -g POWERLEVEL9K_VCS_MODIFIED_FOREGROUND='228'
  typeset -g POWERLEVEL9K_VCS_CLOBBERED_FOREGROUND='196'
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_FOREGROUND='147'
  typeset -g POWERLEVEL9K_VCS_SHORTEN_LENGTH=2
  typeset -g POWERLEVEL9K_VCS_SHORTEN_MIN_LENGTH=8
  typeset -g POWERLEVEL9K_VCS_SHORTEN_STRATEGY='truncate_from_right'
  typeset -g POWERLEVEL9K_VCS_GIT_GITHUB_ICON='\uf09b'   # github - \uf09b - 
  ...
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_FOREGROUND=123
  ...
  function prompt_coloredfreeram()
  {
    local free_ram=$(free | grep Mem | awk '{printf("%.2fG", $4/1048576)}')   # Free ram - G
    # local free_ram=$(free | grep Mem | awk '{printf("%.0f", $4/$2 * 100)}')   # Free ram - %
    local symbol=''
    ...
    # p10k segment -f "$color" -i "$symbol" -t "$free_ram%%"   # Free ram - %
  }

  function instant_prompt_coloredfreeram()
  {
    prompt_coloredfreeram
  }

  function prompt_coloredusedram()
  {
    local used_ram=$(free | grep Mem | awk '{printf("%.2fG", $3/1048576)}')   # Used ram - G
    # local free_ram=$(free | grep Mem | awk '{printf("%.0f", $3/$2 * 100)}')   # Used ram - %
    local symbol=''
    ...
    # p10k segment -f "$color" -i "$symbol" -t "$used_ram%%"   # Used ram - %
  }

  function instant_prompt_coloredusedram()
  {
    prompt_coloredusedram
  }
  ...
  #####################################[ swap: used swap ]######################################
  # Swap color.
  typeset -g POWERLEVEL9K_SWAP_FOREGROUND=120
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_LOAD_NORMAL_FOREGROUND=120
  ...
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_FOREGROUND=123
  # Context color in SSH without privileges.
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_FOREGROUND=123
  # Default context color (no privileges, no SSH).
  typeset -g POWERLEVEL9K_CONTEXT_FOREGROUND=123
  ...
  # typeset -g POWERLEVEL9K_BATTERY_{CHARGING,CHARGED}_FOREGROUND=082
  # Show battery in yellow when it's discharging.
  # typeset -g POWERLEVEL9K_BATTERY_DISCONNECTED_FOREGROUND=076
  # Battery pictograms going from low to high level of charge.
  typeset -g POWERLEVEL9K_BATTERY_STAGES='\uf58d\uf579\uf57a\uf57b\uf57c\uf57d\uf57e\uf57f\uf580\uf581\uf578'
  typeset -g POWERLEVEL9K_BATTERY_LEVEL_FOREGROUND=(160 202 208 214 220 226 190 154 112 118 046)
  typeset -g POWERLEVEL9K_BATTERY_CHARGING_STAGES='\uf585\uf586\uf587\uf588\uf589\uf58a\uf584'
  typeset -g POWERLEVEL9K_BATTERY_CHARGING_LEVEL_FOREGROUND=(160 202 208 214 220 226 190 154 112 118 046)
  ...
  ####################################[ time: current time ]####################################
  # Current time color.
  typeset -g POWERLEVEL9K_TIME_FOREGROUND=081
  ...
  typeset -g POWERLEVEL9K_CUSTOM_UPTIME='zsh_uptime'
  typeset -g POWERLEVEL9K_CUSTOM_UPTIME_BACKGROUND='clear'
  typeset -g POWERLEVEL9K_CUSTOM_UPTIME_FOREGROUND='147'
  typeset -g prompt_uptime()
  {
  ...
  typeset -g instant_prompt_uptime()
  {
    prompt_uptime
  }
  ####################################[ history: line number ]####################################
  typeset -g POWERLEVEL9K_HISTORY_FOREGROUND='123'
